...
const resources = [
  {
    ...
    description:
      'Run the full governance pipeline: drift detection, risk scoring, decision, and immutable ledger in one call.',
    icon: BoltIcon,
    pattern: {
      y: 16,
      squares: [
  ...
  },
  {
    ...
    description:
      'Monitor AI agent behavior in real-time using embedding-based drift analysis against safety manifolds.',
    icon: CogIcon,
    pattern: {
      y: -6,
      squares: [
  ...
  },
  {
    ...
    description:
      'Create and manage compliance programs across 14 frameworks with controls, evidence, and policies.',
    icon: CheckIcon,
    pattern: {
      y: 32,
      squares: [
  ...
  },
  {
    ...
    description:
      'Route governance decisions through the Achonye multi-LLM orchestrator for consensus-driven outcomes.',
    icon: BookIcon,
    pattern: {
      y: 22,
      squares: [[0, 1]],
